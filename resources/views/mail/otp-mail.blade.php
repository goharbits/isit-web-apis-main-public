...
<body>
    <div class="email-container">
        ...
        <div class="content">
            ...
            <p>To ensure your account is secure, we require you to verify your email address. Use the OTP (One-Time
                Password) below to complete the verification process:</p>
            <div class="otp">{{ $user['otp'] }}</div>
            <p>To verify your account:</p>
            <ol>
                <li>Open the I-Sit App or visit our website.</li>
                <li>Enter the OTP provided above.</li>
                <li>Follow the instructions to finalize your account setup.</li>
            </ol>

            <p>Need assistance? Our support team is here to help! If you have any questions, feel free to reach out to
                us at <a href="mailto:support@example.com">support@example.com</a> or visit our Help Center.</p>

            <p>Once again, welcome to I-Sit Corp! We’re excited to support you on your journey toward success.</p>
        </div>
        <div class="footer">
